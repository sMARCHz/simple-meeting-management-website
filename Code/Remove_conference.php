...
<head>
	...
	<script language="JavaScript">
		function toggle(source) {
			checkboxes = document.getElementsByName('meet[]');
...
<body>
	...
	<div class="nav" id="bar">
		...
		<a class="active" href="Remove_conference.php"> Remove conference </a>
...
<body>
	...
	FROM `AllMeeting` WHERE CURRENT_DATE()>AllMeeting.Date; ";
		...
		echo "<form  action=\"delete_conference.php\" method=\"post\" >
		<table id=\"r\"><tr><th>
		...
		if (mysqli_num_rows($resultSelect) > 0) {
			...
			while ($row = mysqli_fetch_assoc($resultSelect2)) {
				...
				echo "<tr>
						...
						<input type=\"checkbox\" name=\"meet[]\" id=\"meeting\" value=" . $row["MeetingID"] . "></td>
						
						<td class=\"red\" id=\"t\">" . $row["Topic"] . "</td>
