...
<body>
	...
	FROM `AllMeeting` WHERE CURRENT_DATE()>AllMeeting.Date; ";
		...
		echo "<form  action=\"delete_Document.php\" method=\"post\" >
		<table id=\"r\"><tr><th>
		...
		if (mysqli_num_rows($resultSelect) > 0) {
			...
			while ($row = mysqli_fetch_assoc($resultSelect2)) {
				...
				echo "<tr>
						...
						<input type=\"checkbox\" name=\"doc[]\" id=\"document\" value=" . $row["MeetingID"] . "></td>
		...
		echo "<br>";
		echo "<input type=\"button\" onclick=\"location.href='Add_Document.php?variable=$variable2';\" value=\"ADD\" />";
